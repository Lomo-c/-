...
CREATE TABLE `user_info`  (
  `user_id` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '1' COMMENT '用户id',
...
-- ----------------------------
INSERT INTO `user_info` VALUES ('1', '新用户', 'user@example.com', 'password123', 1, '2000-01-01', '哔哩哔哩大学', '这是我的个人简介', '2025-06-18 12:00:00', '2025-06-18 12:00:00', '127.0.0.1', 1, '这是我的空间公告', 100, 1000, 0, NULL, NULL, NULL, NULL, NULL);
